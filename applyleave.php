...
<head>
	<title> Conge | Employee  | Employee Management System</title>
	<link rel="stylesheet" type="text/css" href="style/styleapply.css">
</head>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class=" homeblack" href="myprofile.php?id=<?php echo $id ?>"">mon Profile</a></li>
				<li><a class=" homeblack" href="empproject.php?id=<?php echo $id ?>"">My Projects</a></li>
				<li><a class=" homered" href="applyleave.php?id=<?php echo $id ?>"">   Congé</a></li>
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
		<div class="wrapper wrapper--w680">
			<div class="card card-1">
				...
				<div class="card-body">
					<h2 class="title">Formulaire de demande </h2>
					<form action="process/applyleaveprocess.php?id=<?php echo $id ?>" method="POST">
						...
						<div class="row row-space">
							<div class="col-2">
								<p>Date Debut</p>
								<div class="input-group">
									<input class="input--style-1" type="date" placeholder="Debut" name="start">
								</div>
							</div>
							<div class="col-2">
								<p> Date Fin</p>
